...
curl -X POST http://localhost:8099/api/items \
-F "item=apple" \
-F "price=99.99" \
-F "quantity=10" \
...
// curl -X GET http://localhost:8099/api/item/apple
...
/*put*/
/*
curl -X PUT -H "Content-Type: application/json" --data '{"item":"apple123","price":"20","quantity":"200","description":"Yummy"}' localhost:8099/api/item/apple
...
/*delete*/ 
/*
curl -X DELETE localhost:8099/api/item/apple123
*/
